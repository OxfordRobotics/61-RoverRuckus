...
@Autonomous(name="Auto61DepotVal", group="Linear Opmode")
public class Auto61DepotVal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double pretime = Double.parseDouble(runtime.toString().substring(0, 5));

        sleep(1500);
        while (goldminerallocation.equals("none") && Double.parseDouble(runtime.toString().substring(0, 5)) - pretime < 10) {
            getVuforia();
            getTfod();
