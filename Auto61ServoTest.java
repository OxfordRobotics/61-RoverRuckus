...
@Autonomous(name="Auto61Test", group="Linear Opmode")
@Disabled
public class Auto61ServoTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //telemetry.addData("pre start position", robot.bucket.getPosition());
        telemetry.update();

        waitForStart();

        telemetry.addData("started btw", "yes");
        //telemetry.addData("started postition", robot.bucket.getPosition());
        telemetry.update();
