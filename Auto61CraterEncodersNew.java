...
@Autonomous(name="Auto61CraterEncodersNew", group="Linear Opmode")
public class Auto61CraterEncodersNew extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (goldminerallocation.equals("left")) {
            drive.turnOneRight( -65, .5 );
            drive.go( -24, .5 );
            drive.turnOneRight( 65, .5 );
            drive.go ( -32, .5 );
            drive.turnOneLeft( -45, 5 );
            drive.go( -48, .8 );
            ...
            drive.turnOneRight( -97.5, .5 );
            drive.go( -17, .5 );
            drive.turnOneRight( 90, .5 );
            drive.go ( -43.5, .5 );
            drive.turnOneLeft( -52.5, .5 );
            drive.go( -42, .8 );
            robot.idolServo.setPosition(1);
            drive.go( 73, .8 );
        }

        sleep(Math.round(30 - getRuntime()) * 1000);
