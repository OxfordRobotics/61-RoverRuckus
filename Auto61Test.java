...
@Autonomous(name="Auto61TestTest", group="Linear Opmode")
@Disabled
public class Auto61Test extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (Double.parseDouble(runtime.toString().substring(0, 5)) < 30) {
            getVuforia();
            getTfod();
